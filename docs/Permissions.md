...
| Permission      | Bit Number | Bit Position (HEX) | Description                                                                                 |
|-----------------|------------|--------------------|---------------------------------------------------------------------------------------------|
...
| Stream Screens        | 7          | 0000 0040    | Allows the user to stream their screen in the channel   |
| View Screen Streams   | 6          | 0000 0020    | Allows the user to view screen streams in the channel   |
| Stream Camera         | 6          | 0000 0010    | Allows the user to stream their camera in the channel   |
